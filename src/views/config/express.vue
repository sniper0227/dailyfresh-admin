<template>
  <div class="app-container">
    <el-form ref="dataForm" :rules="rules" :model="dataForm" status-icon label-width="300px">
      <el-form-item label="免运费所需最低消费" prop="litemall_express_freight_min">
        <el-input v-model="dataForm.litemall_express_freight_min"/>
      </el-form-item>
      <el-form-item label="免运费不足所需运费" prop="litemall_express_freight_value">
        <el-input v-model="dataForm.litemall_express_freight_value"/>
      </el-form-item>
      <el-form-item label="起送价" prop="litemall_express_minorder_total">
        <el-input v-model="dataForm.litemall_express_minorder_total"/>
      </el-form-item>
      <el-form-item>
  ...
  data() {
    return {
      dataForm: {
        ...
        litemall_express_minorder_total: 0
      },
      rules: {
        ...
        litemall_express_minorder_total:[
          { required: true, message: '不能为空', trigger: 'blur' }
        ],
      }
    }
