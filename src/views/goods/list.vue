  ...
  <div class="app-container">
    ...
    <el-form inline size="small">
      <el-form-item label="商品编号">
        <el-input v-model="listQuery.goodsSn" clearable placeholder="请输入商品编号"/>
      </el-form-item>
      ...
      <el-form-item>
        ...
        <el-button type="success" plain icon="el-icon-edit" @click="handleCreate">添加</el-button>
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="浏览/购买量">
        <template slot-scope="scope">
          <div>
            <div>浏览：{{scope.row.pageviews}}</div>
            <div>购买量：{{scope.row.purchaseview}}</div>
          </div>
        </template>
      </el-table-column>
      <el-table-column align="center" label="详细介绍" prop="detail">
        <template slot-scope="scope">
