<template>
  <div class="app-charts">
    ...
    <el-row :gutter="20">
      <el-col :span="8">
        <p> 销售额（含运费）/销售额（不含运费）</p>
        <h3>¥382043.88/¥382043.88</h3>
      </el-col>
      <el-col :span="8">
        <p> 销售毛利（含运费）/销售毛利（不含运费）</p>
        <h3>¥326432.03/¥326432.03</h3>
      </el-col>
      <el-col :span="8">
        <p> 销售毛利率（含运费）/销售毛利率（不含运费）</p>
        <h3>85.44%/85.44%</h3>
      </el-col>
    </el-row>

    <div>
      <h3>销售额趋势2019-12-04 ~ 2019-12-06</h3>
      <ve-line :data="chartData"/>
    </div>

    <div>
      <h3>商户销量排行榜2019-12-04 ~ 2019-12-06</h3>
...
<script>
  ...
  export default {
    components: { VeLine, VeBar, Pagination },
    data() {
      this.chartSettings = {
        dimension: ['日期'],
        metrics: ['访问用户', '下单用户']
