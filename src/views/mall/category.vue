<template>
  <div class="app-container">
    ...
    <el-form inline size="mini">
      <el-form-item>
        <el-button v-permission="['POST /admin/category/create']" type="success" icon="el-icon-edit"
    ...
    <!-- 查询结果 -->
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border highlight-current-row
              row-key="id">
      <el-table-column align="center" label="类目名" prop="name"/>
      <el-table-column align="center" property="iconUrl" label="类目图标">
        <template slot-scope="scope">
          <img v-if="scope.row.iconUrl" :src="scope.row.iconUrl" width="20">
        </template>
      </el-table-column>
