  ...
  <div class="app-container">
    ...
    <el-form inline size="small">
      ...
      <el-form-item label="订单编号">
        <el-input v-model="listQuery.orderSn" clearable placeholder="请输入订单编号"/>
      </el-form-item>
      <el-form-item label="状态">
        <el-select v-model="listQuery.orderStatusArray" multiple placeholder="请选择订单状态">
          <el-option v-for="(key, value) in statusMap" :key="key" :label="key" :value="value"/>
        </el-select>
      </el-form-item>
      <el-form-item>
        <el-button v-permission="['GET /admin/order/list']" type="primary" plain icon="el-icon-search"
      ...
      <el-table-column align="center" label="操作" width="200" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button v-permission="['POST /admin/order/refund']"
                     v-if="scope.row.orderStatus=== 202||scope.row.orderStatus===204" type="primary" size="mini"
      ...
      <section ref="print">
        <el-form :data="orderDetail" label-position="left">
          ...
          <el-form-item label="配送时间">
            <span>{{ orderDetail.order.deliveryDateStr }}（{{ orderDetail.order.deliveryTime }}）</span>
          </el-form-item>
          <el-form-item label="收货信息">
