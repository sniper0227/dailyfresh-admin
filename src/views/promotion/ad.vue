  ...
  <div class="app-container">
    ...
    <el-form inline size="small">
      <el-form-item label="广告标题">
        <el-input v-model="listQuery.name" clearable placeholder="请输入广告标题"/>
      </el-form-item>
      <el-form-item label="广告内容">
        <el-input v-model="listQuery.content" clearable placeholder="请输入广告内容"/>
      </el-form-item>
      <el-form-item>
        <el-button v-permission="['GET /admin/ad/list']" type="primary" plain icon="el-icon-search" @click="handleFilter">查找</el-button>
        <el-button v-permission="['POST /admin/ad/create']" type="success" plain icon="el-icon-edit" @click="handleCreate">添加</el-button>
...
export default {
  ...
  computed: {
    headers() {
      return {
        'dailyfresh-admin-token': getToken()
      }
    }
  },
  created() {
