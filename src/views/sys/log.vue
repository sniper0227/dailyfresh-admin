  ...
  <div class="app-container">
    ...
    <el-form inline size="small">
      <el-form-item label="管理员">
        <el-input v-model="listQuery.admin" clearable placeholder="请输入操作管理员"/>
      </el-form-item>
      <el-form-item>
        <el-button v-permission="['GET /admin/log/list']" type="primary" icon="el-icon-search" @click="handleFilter">查找</el-button>
      </el-form-item>
    </el-form>
