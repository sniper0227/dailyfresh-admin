  ...
  <div class="app-container">
    ...
    <el-form inline size="small">
      <el-form-item label="管理员">
        <el-input v-model="listQuery.username" clearable placeholder="请输入管理员名称"/>
      </el-form-item>
      <el-form-item>
        <el-button v-permission="['GET /admin/admin/list']" type="primary" plain icon="el-icon-search" @click="handleFilter">查找</el-button>
        <el-button v-permission="['POST /admin/admin/create']" type="success" plain icon="el-icon-edit" @click="handleCreate">添加</el-button>
