<template>
  <div class="app-container">
    ...
    <el-form inline size="small">
      ...
      <el-form-item>
        <el-button v-permission="['GET /admin/role/list']" type="primary" plain icon="el-icon-search" @click="handleFilter">查找</el-button>
        <el-button v-permission="['POST /admin/role/create']" type="primary" icon="el-icon-edit" @click="handleCreate">添加</el-button>
      </el-form-item>
    </el-form>
