  ...
  <div class="app-container">
    ...
    <el-form inline size="small">
      <el-form-item label="对象KEY">
        <el-input v-model="listQuery.key" clearable placeholder="请输入对象KEY"/>
      </el-form-item>
      <el-form-item label="对象名称">
        <el-input v-model="listQuery.name" clearable placeholder="请输入对象名称"/>
      </el-form-item>
      <el-form-item>
        <el-button v-permission="['GET /admin/storage/list']" type="primary" plain icon="el-icon-search" @click="handleFilter">查找</el-button>
        <el-button v-permission="['POST /admin/storage/create']" type="success" plain icon="el-icon-edit" @click="handleCreate">添加</el-button>
      ...
      <el-table-column align="center" property="url" label="图片">
        <template slot-scope="scope">
          <el-popover
            ...
            <img slot="reference" :src="scope.row.url" width="40">
          </el-popover>
        </template>
      </el-table-column>
